...
public class MenuPrincipal {
    ...
    public MenuPrincipal() {
        ...
        itemMenuCadastroUsuarios.addActionListener(e -> new CadastroUsuarios().abrirCadastro(principal));
        itemMenuCadastroPessoas.addActionListener(e -> new CadastroPessoas().abrirCadastro(principal));
        itemMenuVisualizacaoListaUsuarios.addActionListener(e -> new ListaUsuarios().abrirLista(principal));
        itemMenuVisualizacaoListaPessoas.addActionListener(e -> new ListaPessoas().abrirLista(principal));
