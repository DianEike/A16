...
public class CadastroUsuarios extends Operacao {
    ...
    public void exibir() {
        ...
        painelCampos.add(new JCheckBox()); // Corrige componente "Ativo"

        dialog.add(painelCampos, BorderLayout.CENTER);
        JButton salvar = new JButton("Salvar");
        salvar.addActionListener(e -> JOptionPane.showMessageDialog(dialog, "Usuário salvo!")); // Exemplo de ação
